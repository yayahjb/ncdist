...
int main(int argc, char ** argv) {
    ...
    double dprim1[6];
    double dprim2[6];
    double rawdist, rawdist2, rawdiff;
    size_t ii;
    char clatsym;
    int argoff;
    ...
    std::cout << "cs6 rawdist: "<< rawdist << std::endl;
    std::cout << 0.1*std::sqrt(rawdist) << std::endl;

    rawdist2 = S6Dist_func(dprim1,dprim2);
    std::cout << "s6 rawdist: "<< rawdist2 << std::endl;
    std::cout << 0.1*std::sqrt(rawdist2) << std::endl;

    rawdiff = rawdist - rawdist2;
    std::cout << "cs6 rawdist - s6 rawdist: "<<rawdiff <<std::endl;
    rawdiff = 2.*(0.1*std::sqrt(rawdist)  -   0.1*std::sqrt(rawdist2))/(0.1*std::sqrt(rawdist)  +   0.1*std::sqrt(rawdist2) + 1.e-20);
    std::cout << "error fraction : "<< rawdiff << std::endl;
    return 0;
}
